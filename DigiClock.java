...
public class DigiClock extends JPanel implements Runnable{
	Thread thread;
	int i,j,k,p=0,q=0;
	...
	private void clockLayout(Graphics g){
		...
		//String Written text
		g.setColor(Color.black);
		g.drawString("Clock Design by : Md Nasir Arafat",300,100);
		g.drawString("UNDER THE GUIDENCE OF:",180,150);
		g.setColor(Color.black);
		g.setFont(new Font("TimesRoman",Font.BOLD,35));
		g.drawString("Mr. Manish Bhatia Sir",595,150);
		//Clock Label
